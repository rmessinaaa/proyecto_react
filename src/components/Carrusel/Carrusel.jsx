    ...
    <div id="carouselExampleCaptions" className="carousel slide">
      ...
      <div className="carousel-inner">
        <div className="carousel-item active">
          <img src="/ilustraciones/03.jpg" className="d-block w-100" alt="..." />
        ...
        <div className="carousel-item">
          <img src="/ilustraciones/04.jpg" className="d-block w-100" alt="..." />
          <div className="carousel-caption d-none d-md-block custom-carousel-caption">
        ...
        <div className="carousel-item">
          <img src="/ilustraciones/5.jpeg" className="d-block w-100" alt="..." />
          <div className="carousel-caption d-none d-md-block custom-carousel-caption">
